...
TEST_CASE("Test win by first column", "[X wins first column] and manager get_wins function")
{
	unique_ptr<TicTacToe> board = make_unique <TicTacToe3>();
...
// 4X4 TicTacToe
TEST_CASE("Check top left to bottom right diagional win and manager get_wins")
{
...
TEST_CASE("Check 2nd column win")
{
	unique_ptr<TicTacToe> board = make_unique <TicTacToe4>();
...
TEST_CASE("Check 3rd column win")
{
	unique_ptr<TicTacToe> board = make_unique <TicTacToe4>();
...
TEST_CASE("Check 4th column win")
{
	unique_ptr<TicTacToe> board = make_unique <TicTacToe4>();
